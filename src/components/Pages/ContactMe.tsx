...
export default function ContactMe() {
  ...
  useEffect(() => {
    ...
    // Initialize EmailJS with your user ID (ทำครั้งเดียวตอน component mount)
    // ต้องนำ PUBLIC KEY จาก EmailJS dashboard มาใส่ตรงนี้
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ใช้ EmailJS ส่งข้อมูลฟอร์มไปยังอีเมล
